...
change.set('n', '<Leader>w', '<cmd>:w | echo "Saved!" <CR>', { noremap = true, silent = true, desc = 'Save current file'})
change.set('n', '<Leader>q', '<cmd>:wq<CR>', { noremap = true, silent = true, desc = 'Save and quit current file'})
change.set('n', '<Leader>Q', '<cmd>:q!<CR>', { noremap = true, silent = true, desc = 'Quit without saving current file'})
