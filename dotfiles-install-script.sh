...
sudo pacman -S --noconfirm adw-gtk-theme neovim neovide vim newsboat fastfetch unzip 7zip thunar feh zathura imagemagick zoxide poppler wl-clipboard yazi rofi-wayland cronie npm go emacs ttf-jetbrains-mono-nerd ueberzugpp \
