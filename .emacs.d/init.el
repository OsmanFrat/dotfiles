...
(use-package general
  ...
  (my-leader-def
    ...
    "oa" '(org-agenda :wk "Open agenda")  ;; Org-agenda kısayolu eklendi
    "oc" '(org-capture :wk "Capture note")  ;; Org-capture kısayolu eklendi
    "l" '(:wk "Lsp")
...
;; Org mode ve Org-agenda ayarları
(use-package org
  ...
  (setq org-hide-emphasis-markers t
        ...
        ;; Org-agenda ayarları
        org-agenda-files '("~/org/")  ;; Org dosyalarınızın bulunduğu dizin
        ...
        '(("t" "Todo" entry (file+headline "~/org/tasks.org" "Görevler")
           "* TODO %?\n  %u\n  %a")))
...
(setq org-fontify-done-headers t
      org-auto-formatting t
